/*
 * Application coolingNewtonLaw
 * Copyright (C) Laboratorio Sirius HPC. 2013 <john@sirius.utp.edu.co>
 * 
coolingNewtonLaw is free software: you can redistribute it and/or modify it
 * under the terms of the GNU General Public License as published by the
 * Free Software Foundation, either version 3 of the License, or
 * (at your option) any later version.
 * 
 * coolingNewtonLaw is distributed in the hope that it will be useful, but
...
#ifndef COOLINGNEWTONLAW_H_
#define COOLINGNEWTONLAW_H_
...
#endif  /* #ifndef COOLINGNEWTONLAW_H_ */
